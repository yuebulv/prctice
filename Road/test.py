...
if __name__ == "__main__":
    # marked_line = [[80.0, 63.8627, 0.0, 1], [81.0, 63.8627, 2, 1], [89.0, 64.1027, 2, 2], [92.0, 64.1927, 2, 2], [92.75, 64.1702, 2, 5], [92.75, 63.3702, -2, 7], [93.25, 63.3702, -1, 7], [93.25, 64.1702, -2, 7], [93.65, 64.1702, 1, 8], [94.75, 64.1702, 2, 8], [100.5268, 71.8726, 2, 8]]
    # dic = {'line': marked_line, 'err': [1]}
    # dic_0 = {}
    # dic_0[1] = dic
    # print(dic_0)
    # print(len(dic_0))
    # print(len(dic_0[1]['line']))
    a = [1, 2]
    b = [3, 4]
    for t in b:
        a.append(t)
